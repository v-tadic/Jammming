...
function Track( {id, name, artist, addTrackToPlaylist, removeTrack, trackIsInPlaylist} ){
    ...
    if(trackIsInPlaylist){
        return (
            <div className={styles.Track}>
                ...
                <button className={styles.TrackButton}   onClick={() => removeTrack({ id, name, artist })}>-</button>
            </div>
        )
    } else {
        return (
